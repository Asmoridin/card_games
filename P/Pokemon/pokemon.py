...
valid_rarities = ['Common', 'Uncommon', 'Rare', 'Illustration Rare', 'Ultra Rare', 'Double Rare',
    ...
    'Rare Radiant', 'Mega Attack Rare', 'Rare Ace']
    ...
    for deck_line in deck_lines:
        ...
        if PROCESS_ENERGY:
            COLORLESS_ENERGY = ['Enriching Energy', 'Jet Energy', 'Legacy Energy',
                ...
                'Spiky Energy', 'Neo Upper Energy', 'Ignition Energy', 'Boomerang Energy',
                'Spiky Energy']
...
if __name__ == "__main__":
    ...
    for deck in sorted_decks:
        ...
        p_sort = sorted(deck.deck_missing_cards.items(), key=lambda x: card_mapping.get(x[0], x[0]))
        for card_num, missing_qty in p_sort:
